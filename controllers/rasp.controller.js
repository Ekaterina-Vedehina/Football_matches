...
class RaspController {
  async createMatch(req, res) {
    const {id, match_date, first_team, second_team} = req.body
    const newTeam = await db.query("INSERT INTO rasp (id, match_date, first_team, second_team) values ($1, $2, $3, $4) RETURNING *", [id, match_date, first_team, second_team])
